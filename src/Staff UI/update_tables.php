                ...
                <div class="container-recent">
                    <div class="card shadow">
                        ...
                        <div class="container-recent__body card__body-form">
                            <form method="POST" action="../Controller/StaffController/update_table.php">
                                <input type="hidden" name="table_id" value="<?php echo $table['data']['table_id']; ?>">
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        <div class="form-col">
                                            <label for="" class="form-col__label">Table Name</label>
                                            <input type="text" name="table_name" class="form-control" value="<?php echo $table['data']['table_name']; ?>" readonly>
                                        </div>

                                        <div class="form-col">
                                            <label for="" class="form-col__label">Table Size</label>
                                            <input type="number" name="table_size" class="form-control" value="<?php echo $table['data']['size'];?>" readonly>
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        <div class="form-col">
                                            ...
                                            <textarea name="table_desc" readonly rows="2" class="form-control"><?php echo $table['data']['description'];?></textarea>
                                        </div>
                                    </div>
                                </div>
