                                    ...
                                    <tr>
                                        ...
                                        <th class="text-column" scope="row">
                                            <div class="text-column__action">
                                                <a href="../Controller/StaffController/delete_order.php?id=<?php echo $order['reservation_id'];?>&product_id=<?php echo $order['prod_id'];?>" class="btn-control btn-control-delete">
