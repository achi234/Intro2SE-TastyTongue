<?php
    ...
    if(isset($_POST['btn-updateReservation']))
    {
        ...
        {
            redirect('../../Staff UI/update_reservations.php?id='.$reservation_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                redirect('../../Staff UI/update_reservations.php?id='.$reservation_id, 'Cannot book a reservation for a date in the past! Please try again', "");
                exit(0);
            } 
            ...
            if ($selectedHour >= $startHour && $selectedHour <= $endHour) {
                ...
                redirect('../../Staff UI/update_reservations.php?id='.$reservation_id, "The time is not within the restaurant's operating hours (10am - 10pm). Please re-enter.", "");
                exit(0);
            }
            ...
            if($check = false){
                redirect('../../Staff UI/update_reservations.php?id='.$reservation_id, ". Please re-enter.", "");
                exit(0);
            }
            ...
            if($result)
            {
                redirect('../../Staff UI/reservations.php', '', "You've modified reservation with ID " .$reservation_id. " successfully!");
            }
            else
            {
                redirect('../../Staff UI/update_reservations.php?id='.$reservation_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>