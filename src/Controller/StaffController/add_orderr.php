<?php
    ...
    if(isset($_POST['btn-add-order']))
    {
        ...
        {
            redirect('../../Staff UI/add_orders.php?id='.$prod_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            if ($count > 0) {
                ...
                if ($updateResult) {
                    ...
                    redirect('../../Staff UI/orders.php', '', "You've update order {$prod_name} for reservation {$reservation_id} successfully!");
                } else {
                    echo "Lỗi khi thực hiện UPDATE: " . $updateStmt->error;
                    redirect('../../Staff UI/add_orders.php?id='.$prod_id, '', "Something went wrong! Please enter again...");
                }
                ...
                if ($insertResult) {
                    ...
                    redirect('../../Staff UI/orders.php', '', "You've made order {$prod_name} for reservation {$reservation_id} successfully!");
                } else {
