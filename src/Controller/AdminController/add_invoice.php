        ...
        else
        {
            ...
            if ($count > 0) {
                ...
                if ($updateResult) {
                    ...
                    redirect('../../Admin UI/invoices.php', '', "You've update invoice!");
                } else {
                    echo "Lỗi khi thực hiện UPDATE: " . $updateStmt->error;
                    redirect('../../Admin UI/add_invoices.php', '', "Something went wrong! Please enter again...");
                }
                ...
                if($updateResult) {
                    ...
                    redirect('../../Admin UI/invoices.php', '', "You've made order successfully!");
                } else {
