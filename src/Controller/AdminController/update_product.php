<?php
    ...
    if(isset($_POST['btn-updateProduct']))
    {
        ...
        {
            redirect('../../Admin UI/update_products.php?id='.$product_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            if($compile_productCheck)
            {
                ...
                {
                    redirect('../../Admin UI/update_products.php?id='.$product_id, '{$product_name} has already created.', '');
                    exit(0);
                }
            }
            if(!empty($prod_img))
            ...
            if($result)
            {
                redirect('../../Admin UI/products.php', '', "You've modified product successfully!");
            }
            else
            {
                redirect('../../Admin UI/update_products.php?id='.$product_id, '', "Something went wrong! Please enter again...");
            }
        }
