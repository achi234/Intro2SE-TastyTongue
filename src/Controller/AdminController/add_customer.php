<?php
    ...
    if(isset($_POST['btn-addCustomer']))
    {
        ...
        {
            redirect('../../Admin UI/add_customers.php', 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            if($compile_emailCheck)
            {
                ...
                {
                    redirect('../../Admin UI/add_customers.php', 'Email has already register. Please choose another email', '');
                    exit(0);
                }
            }
            ...
            {
                redirect('../../Admin UI/add_customers.php', '', "Something went wrong! Please enter again...");
            }
        }
