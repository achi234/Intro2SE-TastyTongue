<?php
    ...
    if(isset($_POST['btn-updateCustomer']))
    {
        ...
        {
            redirect('../../Admin UI/update_customers.php?id='.$customer_id, 'All fields are required.', '');
            exit(0);
        }
        else
        {
            ...
            {
                redirect('../../Admin UI/update_customers.php?id='.$customer_id, 'Something went wrong! Please enter again...', "");
            }
        }
    }
?>