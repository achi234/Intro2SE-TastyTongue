                ...
                <div class="container-recent">
                    <div class="card shadow">
                        ...
                        <div class="container-recent__body card__body-form">
                            <form method="POST" action="../Controller/AdminController/add_reservation.php" id="reservationForm">
                                <div class="form-row">
    ...
    <script>
        $(document).ready(function() {
            ...
            function sendData() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../Controller/AdminController/process_reservation.php",
                    // url: "../Controller/AdminController/test.php",
                    data: {
